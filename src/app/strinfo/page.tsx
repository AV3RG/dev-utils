      ...
      <Card>
        ...
        <CardContent className={"flex flex-col gap-y-4"}>
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Browsers will change line endings to LF when pasting text. Use the
              upload feature to preserve line endings. Upon any modification to
              the file uploaded, the line endings will be converted to LF.
            </AlertDescription>
          </Alert>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <p className="text-2xl font-bold text-foreground">
                {displayFormatted} {additionalUnit}
                {unit}
              </p>
            </CardContent>
          </Card>
