...
export default function URLEncoder() {
    ...
    const handleDecodedChange = (normalValue: string) => {
        try {
            ...
            setEncodingError('')
            setEncoded(encodeURIComponent(normalValue))
        } catch (e) {
    ...
    const handleEncodedChange = (encodedValue: string) => {
        try {
            ...
            setDecodingError('')
            setDecoded(decodeURIComponent(encodedValue))
        } catch (e) {
    ...
    return (
        <div className={"container mx-auto p-4"}>
            <div className="flex justify-between items-center mb-4">
                <h1 className="text-2xl font-bold">URI Encoder/Decoder</h1>
            </div>
                ...
                <Card>
                    ...
                    <CardContent className={"min-h-full"}>
                        ...
                        <UserInputControls
                            ...
                            sampleDataUrl={"https://devutils.rohan.gg/samples/uri-decoded.txt"}
                        />
                ...
                <Card>
                    ...
                    <CardContent className={"min-h-full"}>
                        ...
                        <UserInputControls
                            ...
                            sampleDataUrl={"https://devutils.rohan.gg/samples/uri-encoded.txt"}
                        />
                        <div className="mt-4 h-full relative">
                            <Textarea
                                id={"encoded-textarea"}
